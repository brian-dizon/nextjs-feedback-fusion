import { Bug, CatIcon, Lightbulb, Palette, Sparkle, Wrench } from "lucide-react";

// list the array of category types
export const CATEGORIES_TYPES = ["Feature", "Improvement", "Bug", "Design", "Other"];

// object responsible for the styles of each category type
const CATEGORIES = {
  Feature: {
